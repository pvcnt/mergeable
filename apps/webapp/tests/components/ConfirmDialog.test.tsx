...
describe("confirm dialog", () => {
    ...
    it("should render when open", () => {
        ...
        render(<ConfirmDialog isOpen={true}><>Please confirm</></ConfirmDialog>);
    ...
    it("should not render when closed", () => {
        ...
        render(<ConfirmDialog isOpen={false}><>Please confirm</></ConfirmDialog>);
    ...
    it("should submit", async () => {
        ...
        render(<ConfirmDialog isOpen={true} onSubmit={handleSubmit} onClose={handleClose}/>);

...
export default function OrgSelector({ selected, onChange }: Props) {
    ...
    const renderNewItem = (q: string, active: boolean) => {
        return <MenuItem roleStructure="listoption" icon="add" text={q} active={active} shouldDismissPopover={false}/>;
    }
    ...
    return (
        <MultiSelect<string>
            ...
            placeholder=""
            noResults={<MenuItem text="Please type something..." roleStructure="listoption" disabled/>}
